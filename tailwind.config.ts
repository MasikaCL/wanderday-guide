    ...
    extend: {
      ...
      colors: {
        ...
        category: {
          ...
          "food-foreground": "hsl(var(--cat-food-foreground))",
          transport: "hsl(var(--cat-transport))",
          "transport-foreground": "hsl(var(--cat-transport-foreground))",
          sight: "hsl(var(--cat-sight))",
          "sight-foreground": "hsl(var(--cat-sight-foreground))",
          break: "hsl(var(--cat-break))",
          "break-foreground": "hsl(var(--cat-break-foreground))",
          gelato: "hsl(var(--cat-gelato))",
          "gelato-foreground": "hsl(var(--cat-gelato-foreground))",
        },
        sidebar: {
