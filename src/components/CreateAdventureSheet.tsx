      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-0 bottom-0 z-50 max-h-[90vh] overflow-y-auto rounded-t-3xl bg-card border-t-[2.5px] border-x-[2.5px] border-foreground safe-bottom"
          >
            ...
            <div className="px-5 pb-6">
                ...
                <div className="grid grid-cols-3 gap-3 mt-2">
                  {SHAPE_VARIANTS.map((v) => (
                    <button key={v} onClick={() => setShape(v)}
                      className={`sticker rounded-2xl p-3 flex items-center justify-center transition-all ${
                        shape === v ? "bg-primary/20" : "bg-background"
                      }`}
                    >
              ...
              <motion.button
                ...
                className="w-full sticker-btn bg-primary text-primary-foreground py-4 text-base font-display tilt-left disabled:opacity-40"
              >
